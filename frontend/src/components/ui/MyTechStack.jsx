...
const techStack = [
  ...
  { name: "cPanel", icon: <SiCpanel className="text-blue-500" /> },
...
const MyTechStack = () => {
  return (
    <div className=" text-white py-8 sm:py-6 md:px-5 lg:px-12 xl:px-16 text-center relative z-50">
      <h1 className="text-4xl font-bold my-4 text-white">My Tech Stack</h1>
      <div className="w-[88%] flex flex-wrap justify-center gap-4 mt-8 max-w-6xl mx-auto">
        {techStack.map((tech, idx) => (
          <div
            key={idx}
            className="flex items-center gap-2 px-5 py-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-full shadow hover:bg-white/20 hover:scale-105 transition-all duration-300 button-hover"
          >
