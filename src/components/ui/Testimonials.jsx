          ...
          {testimonials.map((testimonial, index) => {
            ...
            return (
              <div
                ...
                className={`bg-[#1f1f1f] p-6 rounded-2xl shadow-lg flex flex-col justify-between text-left hover:scale-105 transition duration-300 ease-in-out ${animationClass}`}
              >
                <div>
