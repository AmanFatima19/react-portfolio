...
const ContactForm = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-black px-4 py-6 md:py-12 lg:py-12">
      <div className="bg-[#1f1f1f] text-white w-full max-w-2xl p-6 sm:p-8 rounded-2xl shadow-xl">
